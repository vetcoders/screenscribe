...
window.I18N_BUNDLE = {
    "en": {
        ...
        "review": {
            ...
            "unmergeFinding": "Unmerge",
            "unmergeDone": "Merged finding split into its original moments",
            "unmergeUnavailable": "This merge cannot be split in the current review",
            "mergedBadge": "MERGED",
            "mergedFromLabel": "Merged from",
            "mergedFrom": "Merged from",
            "mergedEvidence": "Merged evidence frames",
            "mergeSelectLabel": "Select finding {{id}} for merge",
            "mergedScreenshotAlt": "Merged finding screenshot at {{ts}}",
            ...
            "resetReviewConfirm": "Reset the entire review? This clears the reviewer name, decisions, notes, manual merges, and manual moments, including saved changes. This cannot be undone.",
            "resetReviewDone": "Review reset to the generated report",
            "resetReviewFailed": "Review reset failed: {{message}}",
            "momentsCountDescription": "Moments: {{count}} total, including rejected",
    ...
    "pl": {
        ...
        "media": {
            ...
            "toolSelect": "Zaznacz",
            "toolDelete": "Usuń",
            "propStroke": "Grubość kreski",
            "propFontSize": "Rozmiar czcionki",
            "toolUndo": "Cofnij",
            "toolClear": "Wyczyść",
            "toolDone": "Gotowe",
        ...
        "review": {
            ...
            "unmergeFinding": "Rozłącz",
            "unmergeDone": "Scalone znalezisko rozdzielono na pierwotne momenty",
            "unmergeUnavailable": "Tego scalenia nie można rozdzielić w bieżącej recenzji",
            "mergedBadge": "SCALONE",
            "mergedFromLabel": "Scalone z",
            "mergedFrom": "Scalone z",
            "mergedEvidence": "Scalone klatki dowodowe",
            "mergeSelectLabel": "Zaznacz znalezisko {{id}} do scalenia",
            "mergedScreenshotAlt": "Screenshot scalonego znaleziska o {{ts}}",
            ...
            "resetReviewConfirm": "Zresetować całą recenzję? Spowoduje to usunięcie nazwy recenzenta, decyzji, notatek, ręcznych scaleń i ręcznych momentów, również zapisanych zmian. Tej operacji nie można cofnąć.",
            "resetReviewDone": "Recenzja została zresetowana do wygenerowanego raportu",
            "resetReviewFailed": "Nie udało się zresetować recenzji: {{message}}",
            "momentsCountDescription": "Momenty: łącznie {{count}}, w tym odrzucone",
