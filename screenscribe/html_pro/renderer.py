...
def render_html_report_pro(
    ...
    context = {
        ...
        "t_tool_select": html.escape(_t("toolSelect", ui_language)),
        "t_tool_delete": html.escape(_t("toolDelete", ui_language)),
        "t_prop_stroke": html.escape(_t("propStroke", ui_language)),
        "t_prop_font_size": html.escape(_t("propFontSize", ui_language)),
